 ...
 *         tickerId: string, // the id of the ticker. You can use this to get the ticker from tickers.currentTickers
 *     ): void {
...
export default abstract class TickerBase<TArgs extends TickerArgs> implements Ticker<TArgs> {
     ...
     * This method should be overridden and you can use `canvas.find()` (from `@drincs/pixi-vn/canvas`)
     * to get the canvas element of the canvas, and edit them.
     * @param _ticker The ticker that is calling this method
     * @param _args The arguments that you passed when you added the ticker
     * @param _alias The alias of the canvas elements that are connected to this ticker
     * @param _tickerId The id of the ticker. You can use this to get the ticker from `tickers.currentTickers`
     */
    abstract fn(
        _ticker: TickerValue,
        _args: TArgs,
